...
_<b>NOTE:</b> The following below uses materials created in the previous demonstration, ["Creating an Azure Account ➔ Establishing a Virtual Machine"](https://github.com/JTYKolesar/azure-start)._
